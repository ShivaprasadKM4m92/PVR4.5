# 1 "c:\\project\\pvr\\scripts\\updated\\s01_adhocreprtconfglib\\\\combined_S01_AdhocReprtConfgLib.c"
...
# 1 "c:\\project\\pvr\\scripts\\updated\\s01_adhocreprtconfglib\\\\combined_S01_AdhocReprtConfgLib.c" 2
...
# 2 "c:\\project\\pvr\\scripts\\updated\\s01_adhocreprtconfglib\\\\combined_S01_AdhocReprtConfgLib.c" 2
...
# 3 "c:\\project\\pvr\\scripts\\updated\\s01_adhocreprtconfglib\\\\combined_S01_AdhocReprtConfgLib.c" 2
...
# 4 "c:\\project\\pvr\\scripts\\updated\\s01_adhocreprtconfglib\\\\combined_S01_AdhocReprtConfgLib.c" 2
...
Action()
{
	...
	lr_start_transaction("S01_T03_NavigateAdhocReport_ConfigurationLibrary");
	...
	lr_end_transaction("S01_T03_NavigateAdhocReport_ConfigurationLibrary",2);

	lr_think_time(3);

	lr_start_transaction("S01_T04_Search");
	...
	lr_end_transaction("S01_T04_Search",2);

	lr_think_time(3);

	lr_start_transaction("S01_T05_EditReportName");
	...
	web_concurrent_end(0);
	lr_end_transaction("S01_T05_EditReportName",2);

	lr_think_time(3);

	lr_start_transaction("S01_T06_UpdateChanges_Run");
	...
	lr_end_transaction("S01_T06_UpdateChanges_Run",2);

	lr_think_time(3);

	lr_start_transaction("S01_T07_NavigateAdhocReport_ConfigurationLibrary");
	...
	lr_end_transaction("S01_T07_NavigateAdhocReport_ConfigurationLibrary",2);
	...
	lr_start_transaction("S01_T08_ClearFilter");
	...
	lr_end_transaction("S01_T08_ClearFilter",2);

	lr_think_time(3);

	lr_start_transaction("S01_T09_Logout");
	...
	lr_end_transaction("S01_T09_Logout",2);

	lr_think_time(3);

	return 0;
}
# 5 "c:\\project\\pvr\\scripts\\updated\\s01_adhocreprtconfglib\\\\combined_S01_AdhocReprtConfgLib.c" 2
...
# 6 "c:\\project\\pvr\\scripts\\updated\\s01_adhocreprtconfglib\\\\combined_S01_AdhocReprtConfgLib.c" 2
