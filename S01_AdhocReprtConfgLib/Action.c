...
//		LAST);
	...
	lr_end_transaction("S01_T03_NavigateAdhocReport_ConfigurationLibrary",LR_AUTO);
	...
	lr_end_transaction("S01_T04_Search",LR_AUTO);
...
//		LAST);
	...
	web_concurrent_end(NULL);
	lr_end_transaction("S01_T05_EditReportName",LR_AUTO);
...
//		LAST);
	...
	lr_end_transaction("S01_T06_UpdateChanges_Run",LR_AUTO);
...
//		LAST);
	...
	lr_end_transaction("S01_T07_NavigateAdhocReport_ConfigurationLibrary",LR_AUTO);
...
//		LAST);
	...
	lr_end_transaction("S01_T08_ClearFilter",LR_AUTO);
	...
	lr_end_transaction("S01_T09_Logout",LR_AUTO);
