...
//		"websocket");addDynatraceHeaderTest("TSN=S03_T02_Login;PC=websocket;SI=LoadRunner;LSN=S03_AdhocReport_GenReport;");
...
//	web_add_header("Upgrade", 
//		"websocket");addDynatraceHeaderTest("TSN=S03_T03_NavigateAdhocReport_GeneratedReports;PC=websocket_2;SI=LoadRunner;LSN=S03_AdhocReport_GenReport;");
...
//		LAST);
	...
	lr_end_transaction("S03_T03_NavigateAdhocReport_GeneratedReports",LR_AUTO);
	...
	lr_end_transaction("S03_T04_SearchReports",LR_AUTO);
...
//	web_add_header("Upgrade", 
//		"websocket");addDynatraceHeaderTest("TSN=S03_T05_ViewReports;PC=websocket_3;SI=LoadRunner;LSN=S03_AdhocReport_GenReport;");
...
//		LAST);
	...
	lr_end_transaction("S03_T05_ViewReports",LR_AUTO);
	...
	lr_end_transaction("S03_T06_DownloadPDF",LR_AUTO);
	...
	lr_end_transaction("S03_T07_DownloadExcel",LR_AUTO);
...
//	web_add_header("Upgrade", 
//		"websocket");addDynatraceHeaderTest("TSN=S03_T08_ClickBack;PC=websocket_4;SI=LoadRunner;LSN=S03_AdhocReport_GenReport;");
...
//		LAST);
	...
	lr_end_transaction("S03_T08_ClickBack",LR_AUTO);
...
//		LAST);
	...
	lr_end_transaction("S03_T09_Click_New(State)",LR_AUTO);
	...
	lr_end_transaction("S03_T10_Click_Confirm",LR_AUTO);
	...
	lr_end_transaction("S03_T11_Click_UnderReview",LR_AUTO);
...
//		LAST);
	...
	lr_end_transaction("S03_T12_Click_Confirm",LR_AUTO);
...
//	web_add_header("Upgrade", 
//		"websocket");addDynatraceHeaderTest("TSN=S03_T13_CreationActionItem;PC=websocket_5;SI=LoadRunner;LSN=S03_AdhocReport_GenReport;");
...
//		LAST);
	...
	lr_end_transaction("S03_T13_CreationActionItem",LR_AUTO);
...
//	web_add_header("Upgrade", 
//		"websocket");addDynatraceHeaderTest("TSN=S03_T14_Archive;PC=websocket_6;SI=LoadRunner;LSN=S03_AdhocReport_GenReport;");
...
//		LAST);
	...
	lr_end_transaction("S03_T14_Archive",LR_AUTO);
	...
	lr_end_transaction("S03_T15_ClearFilter",LR_AUTO);
	...
	lr_end_transaction("S03_T16_Logout",LR_AUTO);
