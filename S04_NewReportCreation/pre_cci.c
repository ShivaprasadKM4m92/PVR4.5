# 1 "c:\\project\\pvr\\scripts\\s04_newreportcreation\\\\combined_S04_NewReportCreation.c"
...
# 1 "c:\\project\\pvr\\scripts\\s04_newreportcreation\\\\combined_S04_NewReportCreation.c" 2
...
# 2 "c:\\project\\pvr\\scripts\\s04_newreportcreation\\\\combined_S04_NewReportCreation.c" 2
...
# 3 "c:\\project\\pvr\\scripts\\s04_newreportcreation\\\\combined_S04_NewReportCreation.c" 2
...
# 4 "c:\\project\\pvr\\scripts\\s04_newreportcreation\\\\combined_S04_NewReportCreation.c" 2
...
Action()
{
	...
	lr_end_transaction("S04_T01_OpenApplication",2);
	...
	lr_end_transaction("S04_T02_Login",2);
	...
	lr_end_transaction("S04_T03_NavigateAdhocReport_NewReport",2);
	...
	web_url("keep-alive", 
		"URL={URL}/reports/keep-alive?_=1591009327411", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t118.inf", 
	...
	lr_end_transaction("S04_T04_ClickProductLookUp",2);
	...
	lr_end_transaction("S04_T05_SearchProduct",2);
	...
	lr_end_transaction("S04_T06_SelectProduct",2);
	...
	web_url("customSQLValuesForTemplate", 
		"URL={URL}/reports/template/customSQLValuesForTemplate?templateId=24615&_=1591009327414", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t127.inf", 
	...
	web_url("poiInputsForTemplate", 
		"URL={URL}/reports/template/poiInputsForTemplate?templateId=24615&_=1591009327415", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t128.inf", 
	...
	lr_end_transaction("S04_T04_AddSections_1",2);
	...
	web_url("customSQLValuesForTemplate_2", 
		"URL={URL}/reports/template/customSQLValuesForTemplate?templateId=24798&_=1591009327424", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t139.inf", 
	...
	web_url("poiInputsForTemplate_2", 
		"URL={URL}/reports/template/poiInputsForTemplate?templateId=24798&_=1591009327425", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t140.inf", 
	...
	lr_end_transaction("S04_T05_AddSections_2",2);
	...
	web_url("poiInputsForTemplate_3", 
		"URL={URL}/reports/template/poiInputsForTemplate?templateId=24902&_=1591009327439", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t156.inf", 
	...
	web_url("customSQLValuesForTemplate_3", 
		"URL={URL}/reports/template/customSQLValuesForTemplate?templateId=24902&_=1591009327438", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t157.inf", 
	...
	web_url("keep-alive_5", 
		"URL={URL}/reports/keep-alive?_=1591009327447", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create", 
		"Snapshot=t167.inf", 
	...
	lr_end_transaction("S04_T06_AddSections_3",2);
	...
	lr_end_transaction("S04_T07_SaveAndRun",2);
	...
	lr_end_transaction("S04_T08_Logout",2);

	lr_think_time(3);

	return 0;
}
# 5 "c:\\project\\pvr\\scripts\\s04_newreportcreation\\\\combined_S04_NewReportCreation.c" 2
...
# 6 "c:\\project\\pvr\\scripts\\s04_newreportcreation\\\\combined_S04_NewReportCreation.c" 2
