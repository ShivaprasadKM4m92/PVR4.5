# 1 "c:\\project\\pvr\\scripts\\updated\\s11_tasks_reportrequests actionitems\\\\combined_S11_Tasks_ReportRequests ActionItems.c"
...
# 1 "c:\\project\\pvr\\scripts\\updated\\s11_tasks_reportrequests actionitems\\\\combined_S11_Tasks_ReportRequests ActionItems.c" 2
...
# 2 "c:\\project\\pvr\\scripts\\updated\\s11_tasks_reportrequests actionitems\\\\combined_S11_Tasks_ReportRequests ActionItems.c" 2
...
# 3 "c:\\project\\pvr\\scripts\\updated\\s11_tasks_reportrequests actionitems\\\\combined_S11_Tasks_ReportRequests ActionItems.c" 2
...
# 4 "c:\\project\\pvr\\scripts\\updated\\s11_tasks_reportrequests actionitems\\\\combined_S11_Tasks_ReportRequests ActionItems.c" 2
...
Action()
{
	...
	lr_end_transaction("S11_T01_OpenApplication",2);
	...
	lr_end_transaction("S11_T02_Login",2);
	...
	lr_end_transaction("S11_T03_NavigateTasks_ReportRequests",2);
	...
	lr_end_transaction("S11_T04_CreateReportRequests",2);

	lr_think_time(3);

	lr_start_transaction("S11_T05_Click_ProductLookUp");

	lr_end_transaction("S11_T05_Click_ProductLookUp",2);
	...
	lr_end_transaction("S11_T06_SearchProduct",2);
	...
	lr_end_transaction("S11_T07_SelectProduct",2);
	...
	lr_end_transaction("S11_T08_EnterBasicInformation",2);
	...
	lr_end_transaction("S11_T09_Save",2);
	...
	lr_end_transaction("S11_T10_NavigateTasks_ActionItems",2);
	...
	lr_end_transaction("S11_T11_Click_CreateActionItem_EnterDetails",2);
	...
	lr_end_transaction("S11_T12_Save",2);
	...
	lr_end_transaction("S11_T13_Logout",2);

	lr_think_time(3);

	return 0;
}
# 5 "c:\\project\\pvr\\scripts\\updated\\s11_tasks_reportrequests actionitems\\\\combined_S11_Tasks_ReportRequests ActionItems.c" 2
...
# 6 "c:\\project\\pvr\\scripts\\updated\\s11_tasks_reportrequests actionitems\\\\combined_S11_Tasks_ReportRequests ActionItems.c" 2
