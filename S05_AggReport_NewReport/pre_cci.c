# 1 "c:\\project\\pvr\\scripts\\updated\\s05_aggreport_newreport\\\\combined_S05_AggReport_NewReport.c"
...
# 1 "c:\\project\\pvr\\scripts\\updated\\s05_aggreport_newreport\\\\combined_S05_AggReport_NewReport.c" 2
...
# 2 "c:\\project\\pvr\\scripts\\updated\\s05_aggreport_newreport\\\\combined_S05_AggReport_NewReport.c" 2
...
# 3 "c:\\project\\pvr\\scripts\\updated\\s05_aggreport_newreport\\\\combined_S05_AggReport_NewReport.c" 2
...
# 4 "c:\\project\\pvr\\scripts\\updated\\s05_aggreport_newreport\\\\combined_S05_AggReport_NewReport.c" 2
...
Action()
{
	...
	lr_end_transaction("S05_T01_OpenApplication",2);
	...
	web_url("{User_Id}", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1591089585625", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/dashboard/index", 
		"Snapshot=t57.inf", 
	...
	lr_end_transaction("S05_T02_Login",2);

	lr_think_time(3);

	lr_start_transaction("S05_T03_NavigateAggregateReport_NewReport");
	...
	web_reg_find("Search=Body",
		"Text=PV Reports - Aggregate Reports",
		"LAST");

	web_url("create", 
		"URL={URL}/reports/periodicReport/create", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer={URL}/reports/dashboard/index", 
		"Snapshot=t63.inf", 
	...
	web_url("tags-0a636c4c7bc5e4dd91c0e4e6d1889215.js", 
		...
		"Resource=1", 
		"RecContentType=application/javascript", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t64.inf", 
		"LAST");
	...
	web_url("{User_Id}_2", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1591089625231", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t103.inf", 
	...
	lr_end_transaction("S05_T03_NavigateAggregateReport_NewReport",2);

	lr_think_time(3);

	lr_start_transaction("S05_T04_ClickProdLookUp");

	lr_end_transaction("S05_T04_ClickProdLookUp",2);
	...
	lr_end_transaction("S05_T05_SearchProduct",2);
	...
	web_url("keep-alive", 
		"URL={URL}/reports/keep-alive?_=1591089625232", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t123.inf", 
	...
	lr_end_transaction("S05_T06_SelectProduct",2);

	lr_think_time(3);

	lr_start_transaction("S05_T07_AddSection1_ChooseReportTemplate");
	...
	web_url("getTemplateList", 
		"URL={URL}/reports/reportTemplateRest/getTemplateList?term=&page=1&max=30&oldSelectedValue=&_=1591089625233", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t126.inf", 
	...
	web_url("customSQLValuesForTemplate", 
		"URL={URL}/reports/template/customSQLValuesForTemplate?templateId={Template_Id1}&_=1591089625234", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t127.inf", 
	...
	web_url("poiInputsForTemplate", 
		"URL={URL}/reports/template/poiInputsForTemplate?templateId={Template_Id1}&_=1591089625235", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t128.inf", 
	...
	lr_end_transaction("S05_T07_AddSection1_ChooseReportTemplate",2);

	lr_think_time(3);

	lr_start_transaction("S05_T08_AddSection1_ChooseQuery");

	web_url("getQueryList", 
		"URL={URL}/reports/queryRest/getQueryList?isQueryTargetReports=true&term=&page=1&max=30&oldSelectedValue=&_=1591089625236", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t129.inf", 
	...
	web_url("queryExpressionValuesForQuery", 
		"URL={URL}/reports/query/queryExpressionValuesForQuery?queryId={Query_Id1}&_=1591089625237", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t130.inf", 
	...
	web_url("customSQLValuesForQuery", 
		"URL={URL}/reports/query/customSQLValuesForQuery?queryId={Query_Id1}&_=1591089625238", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t131.inf", 
	...
	web_url("reportFieldsForQueryValue", 
		"URL={URL}/reports/queryRest/reportFieldsForQueryValue?name=masterCloseDate&_=1591089625240", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t132.inf", 
	...
	web_url("queryExpressionValuesForQuerySet", 
		"URL={URL}/reports/query/queryExpressionValuesForQuerySet?queryId={Query_Id1}&_=1591089625239", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t133.inf", 
	...
	web_url("reportFieldsForQueryValue_2", 
		"URL={URL}/reports/queryRest/reportFieldsForQueryValue?name=masterCloseDate&_=1591089625241", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t135.inf", 
	...
	lr_end_transaction("S05_T08_AddSection1_ChooseQuery",2);

	lr_think_time(3);

	lr_start_transaction("S05_T09_AddSection2_ChooseReportTemplate");

	web_url("getTemplateList_2", 
		"URL={URL}/reports/reportTemplateRest/getTemplateList?term=&page=1&max=30&oldSelectedValue=&_=1591089625243", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t138.inf", 
	...
	web_url("customSQLValuesForTemplate_2", 
		"URL={URL}/reports/template/customSQLValuesForTemplate?templateId={Template_Id2}&_=1591089625244", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t139.inf", 
	...
	web_url("poiInputsForTemplate_2", 
		"URL={URL}/reports/template/poiInputsForTemplate?templateId={Template_Id2}&_=1591089625245", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t140.inf", 
	...
	lr_end_transaction("S05_T09_AddSection2_ChooseReportTemplate",2);

	lr_think_time(3);

	lr_start_transaction("S05_T10_AddSection2_ChooseQuery");

	web_url("getQueryList_2", 
		"URL={URL}/reports/queryRest/getQueryList?isQueryTargetReports=true&term=&page=1&max=30&oldSelectedValue=&_=1591089625246", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t142.inf", 
	...
	web_url("queryExpressionValuesForQuery_2", 
		"URL={URL}/reports/query/queryExpressionValuesForQuery?queryId={Query_Id2}&_=1591089625247", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t143.inf", 
	...
	web_url("customSQLValuesForQuery_2", 
		"URL={URL}/reports/query/customSQLValuesForQuery?queryId={Query_Id2}&_=1591089625248", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t144.inf", 
	...
	web_url("queryExpressionValuesForQuerySet_2", 
		"URL={URL}/reports/query/queryExpressionValuesForQuerySet?queryId={Query_Id2}&_=1591089625249", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t145.inf", 
	...
	web_url("reportFieldsForQueryValue_3", 
		"URL={URL}/reports/queryRest/reportFieldsForQueryValue?name=doseRegimensPackageId&_=1591089625250", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t146.inf", 
	...
	web_url("reportFieldsForQueryValue_4", 
		"URL={URL}/reports/queryRest/reportFieldsForQueryValue?name=doseRegimensLotNo&_=1591089625251", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t147.inf", 
	...
	web_url("possibleValues", 
		"URL={URL}/reports/query/possibleValues?lang=en&field=doseRegimensPackageId&_=1591089625252", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t148.inf", 
	...
	web_url("possibleValues_2", 
		"URL={URL}/reports/query/possibleValues?lang=en&field=doseRegimensPackageId&_=1591089625253", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t149.inf", 
	...
	web_url("possibleValues_3", 
		"URL={URL}/reports/query/possibleValues?lang=en&field=doseRegimensLotNo&_=1591089625254", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t150.inf", 
	...
	web_url("possibleValues_4", 
		"URL={URL}/reports/query/possibleValues?lang=en&field=doseRegimensLotNo&_=1591089625255", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t151.inf", 
	...
	lr_end_transaction("S05_T10_AddSection2_ChooseQuery",2);
	...
	lr_start_transaction("S05_T11_AddSection3_ChooseReportTemplate");

	web_url("getTemplateList_3", 
		"URL={URL}/reports/reportTemplateRest/getTemplateList?term=&page=1&max=30&oldSelectedValue=&_=1591089625256", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t154.inf", 
	...
	web_url("customSQLValuesForTemplate_3", 
		"URL={URL}/reports/template/customSQLValuesForTemplate?templateId={Template_Id3}&_=1591089625257", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t155.inf", 
	...
	web_url("poiInputsForTemplate_3", 
		"URL={URL}/reports/template/poiInputsForTemplate?templateId={Template_Id3}&_=1591089625258", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t156.inf", 
	...
	lr_end_transaction("S05_T11_AddSection3_ChooseReportTemplate",2);

	lr_think_time(3);

	lr_start_transaction("S05_T12_AddSection3_ChooseQuery");

	web_url("getQueryList_3",
		"URL={URL}/reports/queryRest/getQueryList?isQueryTargetReports=true&term=&page=1&max=30&oldSelectedValue=&_=1591089625260", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t159.inf", 
	...
	web_url("queryExpressionValuesForQuery_3", 
		"URL={URL}/reports/query/queryExpressionValuesForQuery?queryId={Query_Id3}&_=1591089625261", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t160.inf", 
	...
	web_url("customSQLValuesForQuery_3", 
		"URL={URL}/reports/query/customSQLValuesForQuery?queryId={Query_Id3}&_=1591089625262", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t161.inf", 
	...
	web_url("queryExpressionValuesForQuerySet_3", 
		"URL={URL}/reports/query/queryExpressionValuesForQuerySet?queryId={Query_Id3}&_=1591089625263", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t162.inf", 
	...
	web_url("reportFieldsForQueryValue_5", 
		"URL={URL}/reports/queryRest/reportFieldsForQueryValue?name=masterPbrerBucket&_=1591089625264", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t163.inf", 
	...
	web_url("possibleValues_5", 
		"URL={URL}/reports/query/possibleValues?lang=en&field=masterPbrerBucket&_=1591089625265", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t164.inf", 
	...
	web_url("possibleValues_6", 
		"URL={URL}/reports/query/possibleValues?lang=en&field=masterPbrerBucket&_=1591089625266", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t165.inf", 
	...
	lr_end_transaction("S05_T12_AddSection3_ChooseQuery",2);

	lr_think_time(3);

	lr_start_transaction("S05_T13_Select_ReportDestinations");

	web_url("getReportingDestinations", 
		"URL={URL}/reports/queryRest/getReportingDestinations?term=&page=1&max=30&_=1591089625267", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t166.inf", 
	...
	web_url("getReportingDestinations_2", 
		"URL={URL}/reports/queryRest/getReportingDestinations?term=&page=1&max=30&_=1591089625268", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t167.inf", 
	...
	web_url("keep-alive_4", 
		"URL={URL}/reports/keep-alive?_=1591089625269", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/periodicReport/create", 
		"Snapshot=t168.inf", 
	...
	lr_end_transaction("S05_T13_Select_ReportDestinations",2);

	lr_think_time(3);

	lr_start_transaction("S05_T14_SaveRun");
	...
	web_submit_data("run",
		"Action={URL}/reports/periodicReport/run",
		"Method=POST",
		"RecContentType=text/html",
		"Referer={URL}/reports/periodicReport/create",
		"Snapshot=t170.inf",
		...
		"Name=templateQueries[0].template", "Value={Template_Id1}", "ENDITEM",
		...
		"Name=templateQueries[0].query", "Value={Query_Id1}", "ENDITEM",
		...
		"Name=templateQueries[0].validQueries", "Value={Query_Id1}", "ENDITEM",
		...
		"Name=templateQueries[1].template", "Value={Template_Id2}", "ENDITEM",
		"Name=templateQueries[_clone]._draftOnly", "Value=", "ENDITEM",
		...
		"Name=templateQueries[_clone]._privacyProtected", "Value=", "ENDITEM",
		"Name=templateQueries[_clone]._blindProtected", "Value=", "ENDITEM",
		"Name=templateQueries[1].query", "Value={Query_Id2}", "ENDITEM",
		...
		"Name=templateQueries[1].validQueries", "Value={Query_Id2}", "ENDITEM",
		...
		"Name=templateQueries[2].template", "Value={Template_Id3}", "ENDITEM",
		"Name=templateQueries[_clone]._draftOnly", "Value=", "ENDITEM",
		...
		"Name=templateQueries[_clone]._privacyProtected", "Value=", "ENDITEM",
		"Name=templateQueries[_clone]._blindProtected", "Value=", "ENDITEM",
		"Name=templateQueries[2].query", "Value={Query_Id3}", "ENDITEM",
		...
		"Name=templateQueries[2].validQueries", "Value={Query_Id3}", "ENDITEM",
		"Name=reportName", "Value={ReportName}", "ENDITEM",
		"Name=periodicReportType", "Value=PBRER", "ENDITEM",
		"Name=description", "Value=PBRER {Description}", "ENDITEM",
		...
		"Name=schedulerTime", "Value={Current_Date} {Current_Time}", "ENDITEM",
		"Name=scheduleDateJSON", "Value={\"startDateTime\":\"{Current_Date}T{SchTime2}Z\",\"timeZone\":{\"text\":\"(GMT +00:00) UTC\\n"
	...
	web_url("{User_Id}_3", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1591089932451", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/executionStatus/list", 
		"Snapshot=t182.inf", 
	...
	lr_end_transaction("S05_T14_SaveRun",2);
	...
	lr_start_transaction("S05_T15_Logout");
	...
	lr_end_transaction("S05_T15_Logout",2);

	lr_think_time(3);

	return 0;
}
# 5 "c:\\project\\pvr\\scripts\\updated\\s05_aggreport_newreport\\\\combined_S05_AggReport_NewReport.c" 2
...
# 6 "c:\\project\\pvr\\scripts\\updated\\s05_aggreport_newreport\\\\combined_S05_AggReport_NewReport.c" 2
