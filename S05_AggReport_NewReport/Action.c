...
/*Correlation comment - Do not change!  Original value='9047c1a1-03d0-4f63-985f-d0883635a2ec' Name ='CsrfTokenId' Type ='Manual'*/
...
//	web_url("websocket", 
//		"URL={URL}/reports/stomp/173/npxjgxf9/websocket", 
//		"Resource=0", 
//		"Referer=", 
//		"Snapshot=t61.inf", 
//		"Mode=HTTP", 
...
/*Correlation comment - Do not change!  Original value='63048780-eb9a-4336-81db-52c77236fa70' Name ='CsrfTokenId_2' Type ='Manual'*/
	web_reg_save_param_ex(
...
//	web_url("websocket_2", 
//		"URL={URL}/reports/stomp/889/5gqgig28/websocket", 
//		"Resource=0", 
//		"Referer=", 
//		"Snapshot=t115.inf", 
//		"Mode=HTTP", 
...
//		"script");
	...
	lr_end_transaction("S05_T03_NavigateAggregateReport_NewReport",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("S05_T04_ClickProdLookUp");

	lr_end_transaction("S05_T04_ClickProdLookUp",LR_AUTO);
...
//		LAST);
	...
	lr_end_transaction("S05_T07_AddSection1_ChooseReportTemplate",LR_AUTO);
	...
	lr_end_transaction("S05_T08_AddSection1_ChooseQuery",LR_AUTO);
	...
	lr_end_transaction("S05_T09_AddSection2_ChooseReportTemplate",LR_AUTO);
	...
	lr_end_transaction("S05_T10_AddSection2_ChooseQuery",LR_AUTO);
	...
	lr_end_transaction("S05_T11_AddSection3_ChooseReportTemplate",LR_AUTO);
	...
	lr_end_transaction("S05_T12_AddSection3_ChooseQuery",LR_AUTO);
...
//		LAST);
	...
	lr_end_transaction("S05_T13_Select_ReportDestinations",LR_AUTO);
...
//		"URL={URL}/reports/keep-alive?_=1591089625270", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/reports/periodicReport/create", 
//		"Snapshot=t169.inf", 
...
//		LAST);
	...
	lr_end_transaction("S05_T14_SaveRun",LR_AUTO);
...
//		"URL={URL}/reports/stomp/249/2_qi3txy/xhr_streaming", 
//		"Method=POST", 
//		"Resource=0", 
//		"RecContentType=text/html", 
//		"Referer={URL}/reports/executionStatus/list", 
...
//		"URL={URL}/reports/stomp/249/mvcmiu8e/xhr", 
//		"Method=POST", 
//		"Resource=0", 
//		"RecContentType=text/html", 
//		"Referer={URL}/reports/executionStatus/list", 
...
//		LAST);
	...
	lr_end_transaction("S05_T15_Logout",LR_AUTO);
