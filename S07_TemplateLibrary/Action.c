...
/*Correlation comment - Do not change!  Original value='777fb9d1-28ad-40ff-abe4-d2fe41a46458' Name ='CsrfTokenId_1' Type ='Manual'*/
...
/*Correlation comment - Do not change!  Original value='ba39333f-d902-4776-97b4-c0c2f5287426' Name ='CsrfTokenId_2' Type ='Manual'*/
	web_reg_save_param_ex(
...
//		"XMLHttpRequest");
	...
	web_url("{User_Id}", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1589965692480", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/dashboard/index", 
		"Snapshot=t55.inf", 
...
//		LAST);
	...
	lr_start_transaction("S07_T03_NavigateTemplates_TemplateLibrary");
...
//		"application/json, text/javascript, */*; q=0.01");
	...
	web_url("{User_Id}_2", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1589965752675", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/template/index", 
		"Snapshot=t85.inf", 
...
//		LAST);
	...
	lr_end_transaction("S07_T03_NavigateTemplates_TemplateLibrary",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("S07_T04_SearchTemplate");
	...
	web_reg_save_param_ex(
		"ParamName=TempId",
		"LB=id\":",
		"RB=,\"category\":\" \",\"name\":\"{Temaplate_Name}",
		SEARCH_FILTERS,
		"Scope=BODY",
		LAST);
	...
	lr_end_transaction("S07_T04_SearchTemplate",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("S07_T05_EditTemplate");
	...
	web_reg_save_param_ex(
		"ParamName=VersionId",
		"LB=name=\"version\" id=\"version\" value=\"",
		"RB=\" />",
		SEARCH_FILTERS,
		"Scope=ALL",
		LAST);

/*Correlation comment - Do not change!  Original value='23934' Name ='CCL_Id1' Type ='Manual'*/
	web_reg_save_param_ex(
		"ParamName=CCL_Id1",
		"LB=name=\"selectCLL_0\" value=\"",
		"RB=\"",
		SEARCH_FILTERS,
		"Scope=Body",
		LAST);

/*Correlation comment - Do not change!  Original value='23998' Name ='CCL_Id2' Type ='Manual'*/
	web_reg_save_param_ex(
		"ParamName=CCL_Id2",
		"LB=name=\"selectCLL_1\" value=\"",
		"RB=\"",
		SEARCH_FILTERS,
		"Scope=Body",
		LAST);

/*Correlation comment - Do not change!  Original value='24026' Name ='CCL_Id3' Type ='Manual'*/
	web_reg_save_param_ex(
		"ParamName=CCL_Id3",
		"LB=name=\"selectCLL_2\" value=\"",
		"RB=\"",
		SEARCH_FILTERS,
		"Scope=Body",
		LAST);

/*Correlation comment - Do not change!  Original value='24055' Name ='CCL_Id4' Type ='Manual'*/
	web_reg_save_param_ex(
		"ParamName=CCL_Id4",
		"LB=name=\"selectCLL_3\" value=\"",
		"RB=\"",
		SEARCH_FILTERS,
		"Scope=Body",
		LAST);

/*Correlation comment - Do not change!  Original value='24192' Name ='CCL_Id5' Type ='Manual'*/
	web_reg_save_param_ex(
		"ParamName=CCL_Id5",
		"LB=name=\"selectCLL_4\" value=\"",
		"RB=\"",
		SEARCH_FILTERS,
		"Scope=Body",
		LAST);

/*Correlation comment - Do not change!  Original value='24083' Name ='CCL_Id6' Type ='Manual'*/
	web_reg_save_param_ex(
		"ParamName=CCL_Id6",
		"LB=name=\"selectCLL_5\" value=\"",
		"RB=\"",
		SEARCH_FILTERS,
		"Scope=Body",
		LAST);

/*Correlation comment - Do not change!  Original value='24224' Name ='CCL_Id7' Type ='Manual'*/
	web_reg_save_param_ex(
		"ParamName=CCL_Id7",
		"LB=name=\"selectCLL_6\" value=\"",
		"RB=\"",
		SEARCH_FILTERS,
		"Scope=Body",
		LAST);

/*Correlation comment - Do not change!  Original value='23690' Name ='CCL_Id8' Type ='Manual'*/
	web_reg_save_param_ex(
		"ParamName=CCL_Id8",
...
/*Correlation comment - Do not change!  Original value='24113' Name ='CCL_Id9' Type ='Manual'*/
	web_reg_save_param_ex(
		"ParamName=CCL_Id9",
		"LB=name=\"selectCLL_8\" value=\"",
		"RB=\"",
		SEARCH_FILTERS,
		"Scope=Body",
		LAST);

/*Correlation comment - Do not change!  Original value='24139' Name ='CCL_Id10' Type ='Manual'*/
	web_reg_save_param_ex(
		"ParamName=CCL_Id10",
		"LB=name=\"selectCLL_9\" value=\"",
		"RB=\"",
		SEARCH_FILTERS,
		"Scope=Body",
		LAST);

/*Correlation comment - Do not change!  Original value='23785' Name ='CCL_Id11' Type ='Manual'*/
	web_reg_save_param_ex(
		"ParamName=CCL_Id11",
		"LB=name=\"selectCLL_10\" value=\"",
		"RB=\"",
		SEARCH_FILTERS,
		"Scope=Body",
		LAST);

/*Correlation comment - Do not change!  Original value='24166' Name ='CCL_Id12' Type ='Manual'*/
	web_reg_save_param_ex(
		"ParamName=CCL_Id12",
		"LB=name=\"selectCLL_11\" value=\"",
		"RB=\"",
		SEARCH_FILTERS,
		"Scope=Body",
		LAST);

/*Correlation comment - Do not change!  Original value='23757' Name ='CCL_Id13' Type ='Manual'*/
	web_reg_save_param_ex(
		"ParamName=CCL_Id13",
		"LB=name=\"selectCLL_12\" value=\"",
		"RB=\"",
		SEARCH_FILTERS,
		"Scope=Body",
		LAST);

/*Correlation comment - Do not change!  Original value='24248' Name ='id' Type ='Manual'*/
	web_reg_save_param_ex(
		"ParamName=CCL_Id14",
		"LB=name=\"selectCLL_13\" value=\"",
		"RB=\"",
		SEARCH_FILTERS,
		"Scope=Body",
		LAST);
	...
	web_url("{TempId}", 
		"URL={URL}/reports/template/edit/{TempId}", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer={URL}/reports/template/index", 
		"Snapshot=t93.inf", 
	...
	web_url("category-b0ba00263a1e3916a858e6a7c54c56a9.js", 
		...
		"Resource=1", 
		"RecContentType=application/javascript", 
		"Referer={URL}/reports/template/edit/{TempId}", 
		"Snapshot=t94.inf", 
		LAST);
...
//		"XMLHttpRequest");
	...
	web_url("getTemplateNameDescription", 
		"URL={URL}/reports/reportTemplateRest/getTemplateNameDescription?id={CCL_Id1}", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/template/edit/{TempId}", 
		"Snapshot=t112.inf", 
	...
	web_url("getTemplateNameDescription_2", 
		"URL={URL}/reports/reportTemplateRest/getTemplateNameDescription?id={CCL_Id2}", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/template/edit/{TempId}", 
		"Snapshot=t113.inf", 
	...
	web_url("getTemplateNameDescription_4", 
		"URL={URL}/reports/reportTemplateRest/getTemplateNameDescription?id={CCL_Id4}", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/template/edit/{TempId}", 
		"Snapshot=t115.inf", 
	...
	web_url("getTemplateNameDescription_5", 
		"URL={URL}/reports/reportTemplateRest/getTemplateNameDescription?id={CCL_Id5}", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/template/edit/{TempId}", 
		"Snapshot=t116.inf", 
	...
	web_url("getTemplateNameDescription_7", 
		"URL={URL}/reports/reportTemplateRest/getTemplateNameDescription?id={CCL_Id8}", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/template/edit/{TempId}", 
		"Snapshot=t118.inf", 
	...
	web_url("getTemplateNameDescription_8", 
		"URL={URL}/reports/reportTemplateRest/getTemplateNameDescription?id={CCL_Id9}", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/template/edit/{TempId}", 
		"Snapshot=t119.inf", 
	...
	web_url("getTemplateNameDescription_11", 
		"URL={URL}/reports/reportTemplateRest/getTemplateNameDescription?id={CCL_Id11}", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/template/edit/{TempId}", 
		"Snapshot=t123.inf", 
	...
	web_url("getTemplateNameDescription_12", 
		"URL={URL}/reports/reportTemplateRest/getTemplateNameDescription?id={CCL_Id13}", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/template/edit/{TempId}", 
		"Snapshot=t124.inf", 
	...
	web_url("getTemplateNameDescription_13", 
		"URL={URL}/reports/reportTemplateRest/getTemplateNameDescription?id={CCL_Id12}", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/template/edit/{TempId}", 
		"Snapshot=t125.inf", 
	...
	web_url("getTemplateNameDescription_14", 
		"URL={URL}/reports/reportTemplateRest/getTemplateNameDescription?id={CCL_Id14}", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/template/edit/{TempId}", 
		"Snapshot=t126.inf", 
...
//		"application/json, text/javascript, */*; q=0.01");
	...
	web_url("{User_Id}_3", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1589965794013", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/template/edit/{TempId}", 
		"Snapshot=t128.inf", 
...
//	web_revert_auto_header("X-Requested-With");
	...
	lr_end_transaction("S07_T05_EditTemplate",LR_AUTO);
...
//		LAST);
	...
	lr_start_transaction("S07_T06_Add_CaseLineListingTemplate_Tag_And_Update");
...
//		LAST);
	...
	web_reg_save_param_ex(
		"ParamName=CLL_15",
		"LB=id\":",
		"RB=,\"text\":\"Case Narrative Listing",
		SEARCH_FILTERS,
		"Scope=BODY",
		LAST);
...
//		"1");
	...
	web_submit_data("update",
		"Action={URL}/reports/template/update?_csrf={CsrfTokenId_2}",
		"Method=POST",
		...
		"Name=selectCLL_0", "Value={CCL_Id1}", ENDITEM,
		"Name=selectCLL_1", "Value={CCL_Id2}", ENDITEM,
		"Name=selectCLL_2", "Value={CCL_Id3}", ENDITEM,
		"Name=selectCLL_3", "Value={CCL_Id4}", ENDITEM,
		"Name=selectCLL_4", "Value={CCL_Id5}", ENDITEM,
		"Name=selectCLL_5", "Value={CCL_Id6}", ENDITEM,
		"Name=selectCLL_6", "Value={CCL_Id7}", ENDITEM,
		"Name=selectCLL_7", "Value={CCL_Id8}", ENDITEM,
		"Name=selectCLL_8", "Value={CCL_Id9}", ENDITEM,
		"Name=selectCLL_9", "Value={CCL_Id10}", ENDITEM,
		"Name=selectCLL_10", "Value={CCL_Id11}", ENDITEM,
		"Name=selectCLL_11", "Value={CCL_Id12}", ENDITEM,
		"Name=selectCLL_12", "Value={CCL_Id13}", ENDITEM,
		"Name=selectCLL_13", "Value={CCL_Id14}", ENDITEM,
		"Name=selectCLL_", "Value={CLL_15}", ENDITEM,
		"Name=selectCLL_", "Value=", ENDITEM,
		"Name=templateSetCLLIds", "Value={CCL_Id1},{CCL_Id2},{CCL_Id3},{CCL_Id4},{CCL_Id5},{CCL_Id6},{CCL_Id7},{CCL_Id8},{CCL_Id9},{CCL_Id10},{CCL_Id11},{CCL_Id12},{CCL_Id13},{CCL_Id14},{CLL_15}", ENDITEM,
		...
		"Name=templateId", "Value={TempId}", ENDITEM,
	...
	web_url("ec.render.min-f6d1f2204b8afac135ad5f0e158f00e8.js", 
		...
		"Resource=1", 
		"RecContentType=application/javascript", 
		"Referer={URL}/reports/template/view/{TempId}", 
		"Snapshot=t139.inf", 
		LAST);
...
//		"XMLHttpRequest");
	...
	web_url("getTemplateNameDescription_27", 
		"URL={URL}/reports/reportTemplateRest/getTemplateNameDescription?id={CLL_15}", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/template/view/{TempId}", 
		"Snapshot=t154.inf", 
...
//		"application/json, text/javascript, */*; q=0.01");
	...
	web_url("{User_Id}_4", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1589965842864", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/template/view/{TempId}", 
		"Snapshot=t156.inf", 
...
//		LAST);
	...
	lr_end_transaction("S07_T06_Add_CaseLineListingTemplate_Tag_And_Update",LR_AUTO);

	lr_think_time(3);

//	lr_start_transaction("S07_T07_Remove_CaseLineListingTemplate_And_ClickUpdate");
//
//	lr_end_transaction("S07_T07_Remove_CaseLineListingTemplate_And_ClickUpdate",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("S07_T07_EditTemplate");
...
/*Correlation comment - Do not change!  Original value='23856' Name ='id' Type ='Manual'*/
//	web_reg_save_param_ex(
//		"ParamName=CLL_15",
//		"LB=name=\"selectCLL_14\" value=\"",
//		"RB=\"",
//		SEARCH_FILTERS,
//		"Scope=Body",
//		LAST);
	...
	web_url("{User_Id}_5", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1589965896039", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/template/edit/{TempId}", 
		"Snapshot=t180.inf", 
	...
	lr_end_transaction("S07_T07_EditTemplate",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("S07_T08_Remove_CaseLineListingTemplate_And_ClickUpdate");
...
//		LAST);
	...
	web_submit_data("update_2",
		...
		"Name=selectCLL_13", "Value={CCL_Id14}", ENDITEM,
		"Name=selectCLL_", "Value=", ENDITEM,
		"Name=templateSetCLLIds", "Value={CCL_Id1},{CCL_Id2},{CCL_Id3},{CCL_Id4},{CCL_Id5},{CCL_Id6},{CCL_Id7},{CCL_Id8},{CCL_Id9},{CCL_Id10},{CCL_Id11},{CCL_Id12},{CCL_Id13},{CCL_Id14}", ENDITEM,
		"Name=_excludeEmptySections", "Value=", ENDITEM,
		"Name=excludeEmptySections", "Value=on", ENDITEM,
		"Name=templateType", "Value=TEMPLATE_SET", ENDITEM,
		"Name=edit", "Value=true", ENDITEM,
		"Name=templateId", "Value={TempId}", ENDITEM,
		"Name=version", "Value={VersionId_2}", ENDITEM,
		"Name=Update", "Value=Update", ENDITEM,
		"Name=_csrf", "Value={CsrfTokenId_2}", ENDITEM,
		LAST);
	...
	web_url("{User_Id}_6", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1589965932442", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/template/view/{TempId}", 
		"Snapshot=t199.inf", 
...
//		LAST);
	...
	lr_end_transaction("S07_T08_Remove_CaseLineListingTemplate_And_ClickUpdate",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("S07_T09_ClickRun");
...
//		"1");
	...
	web_url("create", 
		"URL={URL}/reports/configuration/create?selectedTemplate={TempId}", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer={URL}/reports/template/view/{TempId}", 
		"Snapshot=t203.inf", 
	...
	web_url("templateQueries-b30e257e7bf112701696b0edaac3908d.js", 
		...
		"Resource=1", 
		"RecContentType=application/javascript", 
		"Referer={URL}/reports/configuration/create?selectedTemplate={TempId}", 
		"Snapshot=t204.inf", 
		LAST);
...
//		LAST);
	...
	web_url("getTemplateNameDescription_59", 
		"URL={URL}/reports/reportTemplateRest/getTemplateNameDescription?id={TempId}", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create?selectedTemplate={TempId}", 
		"Snapshot=t230.inf", 
	...
	web_url("{User_Id}_7", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1589965999059", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create?selectedTemplate={TempId}", 
		"Snapshot=t240.inf", 
...
//		LAST);
	...
	lr_end_transaction("S07_T09_ClickRun",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("S07_T10_SearchProduct");
...
/*Correlation comment - Do not change!  Original value='105684' Name ='Product_Ids' Type ='Manual'*/
	web_reg_save_param_ex(
		"ParamName=Product_Ids",
		"LB=\"{ProductLookUpSearch}\",\"id\":\"",
		"RB=\"",
		SEARCH_FILTERS,
		"Scope=Body",
		LAST);
	...
	lr_end_transaction("S07_T10_SearchProduct",LR_AUTO);

	lr_think_time(3);
	
	lr_start_transaction("S07_T11_AddProduct");

	web_custom_request("getSelectedItem", 
		"URL={URL}/reports/productDictionary/getSelectedItem?productId={Product_Ids}&dataSource=pva&dictionaryLevel=3&currentLang=en", 
		"Method=POST", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/configuration/create?selectedTemplate={TempId}", 
	...
	web_submit_data("getPreLevelProductParents", 
		...
		"Name=productIds", "Value={Product_Ids}", ENDITEM, 
		LAST);
...
//		LAST);
	...
	lr_end_transaction("S07_T11_AddProduct",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("S07_T12_Click_Close");

	lr_end_transaction("S07_T12_Click_Close",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("S07_T13_EnterReportName_Click_Save&Run");
...
//		LAST);
	...
	web_submit_data("run",
		...
		ITEMDATA,
		"Name=owner", "Value={User_Id}", ENDITEM,
		"Name=productSelection", "Value={\"1\":[],\"2\":[],\"3\":[{\"name\":\"{ProductLookUpSearch}\",\"id\":\"{Product_Ids}\"}],\"4\":[]}", ENDITEM,
	...
	web_url("{User_Id}_8", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1589966153077", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/executionStatus/list", 
		"Snapshot=t278.inf", 
...
//		LAST);
	...
	lr_end_transaction("S07_T13_EnterReportName_Click_Save&Run",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("S07_T14_NavigateTemplates_TemplateLibrary");
...
//		"application/json, text/javascript, */*; q=0.01");
	...
	web_url("{User_Id}_9", 
		"URL={URL}/reports/notificationRest/forUser/{User_Id}?_=1589966177791", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/reports/template/index", 
		"Snapshot=t291.inf", 
...
//		"XMLHttpRequest");
	...
	lr_end_transaction("S07_T14_NavigateTemplates_TemplateLibrary",LR_AUTO);
...
//		LAST);
	...
	lr_start_transaction("S07_T15_RemoveFilter");
	...
	lr_end_transaction("S07_T15_RemoveFilter",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("S07_T16_Logout");
	...
	web_url("logout", 
		...
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer={URL}/reports/periodicReport/reports", 
		"Snapshot=t181.inf", 
		"Mode=HTTP", 
		LAST);
...
//		LAST);
	...
	lr_end_transaction("S07_T16_Logout",LR_AUTO);
