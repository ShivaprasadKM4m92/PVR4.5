# 1 "c:\\project\\pvr\\scripts\\newscenarios\\report1_adhocreportupdated\\\\combined_Report1_AdhocReportUpdated.c"
...
# 1 "c:\\project\\pvr\\scripts\\newscenarios\\report1_adhocreportupdated\\\\combined_Report1_AdhocReportUpdated.c" 2
...
Action()
{
	...
	lr_end_transaction("Rep1_T01_OpenApplication",2);
	...
	lr_end_transaction("Rep1_T02_Login",2);
	...
	lr_end_transaction("Rep1_T03_NavigateAdhocReport_NewReport",2);

	lr_think_time(3);

	lr_start_transaction("Rep1_T04_ClickProductLookUp");

	lr_end_transaction("Rep1_T04_ClickProductLookUp",2);
	...
	lr_end_transaction("Rep1_T05_SearchProduct",2);
	...
	lr_end_transaction("Rep1_T06_SelectProduct",2);
	...
	lr_end_transaction("Rep1_T07_SelectReportTemplate",2);
	...
	lr_end_transaction("Rep1_T08_SaveAndRun",2);
	...
	lr_end_transaction("Rep1_T09_Logout",2);
